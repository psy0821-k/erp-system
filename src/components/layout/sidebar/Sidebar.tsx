...
const Sidebar = () => {
  return (
    <div className="flex justify-between items-center flex-col w-64 bg-[#1E293B] text-white h-screen left-0 top-0 transition-all duration-300 border-r border-white/10`">
      <nav>
