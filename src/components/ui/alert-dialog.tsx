...
function AlertDialogOverlay({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Overlay>) {
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-black/40 backdrop-blur-[2px] duration-150',
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          'group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-[calc(100%-2rem)]',
          '-translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl',
          'border border-slate-200 bg-white p-5 text-slate-900 shadow-xl outline-none',
          'duration-150',
          ...
          'dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:shadow-2xl',
...
function AlertDialogDescription({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Description>) {
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        'text-balance text-sm text-slate-600 md:text-pretty',
