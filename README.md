...
본 프로젝트를 통해 관리자 시스템 설계 경험과 실무형 UI 개발 경험을 쌓을 수 있었습니다.

단순 CRUD 구현을 넘어 권한 관리, 데이터 시각화, 인증, 재사용 가능한 컴포넌트 설계를 경험하며 서비스 규모가 커졌을 때의 구조 설계 방법을 학습할 수 있었습니다.
